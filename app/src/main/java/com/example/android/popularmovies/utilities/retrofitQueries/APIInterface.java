...
public interface APIInterface {
    ...
    @GET("movie/popular?")
    Call<MovieRequestResult> getPopularMovies(@Query("api_key") String apiKey, @Query("page") int page);

    @GET("movie/top_rated?")
    Call<MovieRequestResult> getTopRatedMovies(@Query("api_key") String apiKey, @Query("page") int page);
